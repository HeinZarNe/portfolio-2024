...
const TechStack = () => {
  ...
  return (
    <div className="w-full relative flex flex-col gap-12 items-center justify-center box-shadow py-28 border-[#171718] border-2 bg-[#0f0f10]">
      ...
      <div className="sm:hidden flex flex-row flex-wrap gap-3 items-center justify-center w-full ">
        <img
          src="/js.svg"
          alt="javascript"
